<?php get_header(); ?>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-8 text-center">
                    <h1 class="text-white mt-0">Nós temos o que voce precisa!</h1>
                    <hr class="divider light my-4">
                    <h5 class="text-white mb-4">Mão de obra de qualidade e confiança com o preço camarada para concluir o seu projeto!</h5>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            ...
            <div class="row " id="container-services">   
                <div class="card text-center">
                    <img class="card-img-top" src="<?php bloginfo('template_directory'); ?>/images/serveces-hidraulica.png" alt="Card image cap">
                    <div class="card-body">
                ...
                <div class="card text-center">
                    <img class="card-img-top" src="<?php bloginfo('template_directory'); ?>/images/pintura-service.jpg" alt="Card image cap">
                    <div class="card-body">
                ...
                <div class="card text-center">
                    <img class="card-img-top" src="<?php bloginfo('template_directory'); ?>/images/services-gesso.jpg" alt="Card image cap">
                    <div class="card-body">
                ...
                <div class="card text-center">
                    <img class="card-img-top" src="<?php bloginfo('template_directory'); ?>/images/services-alvenaria.jpg"alt="Card image cap">
                    <div class="card-body">
                ...
                <div class="card text-center">
                    <img class="card-img-top" src="<?php bloginfo('template_directory'); ?>/images/services-revestimento.jpg" alt="Card image cap">
                    <div class="card-body">
                ...
                <div class="card text-center">
                    <img class="card-img-top" src="<?php bloginfo('template_directory'); ?>/images/services-eletrica.jpg" alt="Card image cap">
                    <div class="card-body">
    ...
    <!-- Portfolio-->
    <section class="page-section  text-white mt-5 bg-dark" id="section3">
        <div class="container col-12 col-md-12 row d-flex justify-content-center">
            <div class="col-lg-5 align-bottom">
                <div class="align-bottom">
                    <h1 class="text-center ">Quem Sou</h1>
                    <p class="text-center mt-2">Me chamo Jorge Mateus, tenho 53 anos e 27 anos de carreira. Possuo Amplo conhecimento em diversas áreas da construção civil, atuamos nas mais variadas regiões do Rio de Janeiro. Precisando de um orçamento? eu irei pessoalmente ao seu encontro para que seja feito com exatidão</p>
                    <hr class="divider my-4">
                    <h5 class="text-center mt-2">CNPJ:  23.430.014/0001­40 </h5>
                    
                </div>
            </div>
            <div class="card  " id="img-quemsomos">
                <img class="card-img-top" src="<?php bloginfo('template_directory'); ?>/images/foto-perfil.jpg" alt="Card image cap">
                <div class="card-body">
                </div>
            </div>
        </div>
    ...
    <section class="page-section" id="contact">
        <div class="container">
            ...
            <div class="row bg-dark "  >
                <div class="col-lg-4 ml-auto text-center mt-5 mb-5 mb-lg-0">
                    ...
                    <h5 class="text-white" >(21)  9921-47827</h5></p>
                </div>
                <div class="col-lg-4 mr-auto mt-5 text-center">
                    ...
                    <a class="d-block" href="mailto:sebastiaojorgeobras@gmail.com"><h5>sebastiaojorgeobras@gmail.com</h5></a>
                </div>
            </div>
        </div>
